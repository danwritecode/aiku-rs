...
pub fn CreateHaiku(mut on_created: impl FnMut(String) + 'static) -> impl IntoView {
    ...
    // Create an effect that watches the haiku_url signal and calls on_created when it changes
    Effect::new(move |_| {
    ...
    view! {
        <div class="pt-56 max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-3 gap-4 h-full" style="font-family: 'Zen Old Mincho';">
            <div class="col-span-1 flex flex-col items-center text-4xl font-black text-black space-y-1">
            ...
            <div class="col-span-1 flex flex-col items-center">
                ...
                <div class="w-full mt-6">
                    <button 
                        on:click=move |_| {
                            let set_haiku_url = set_haiku_url.clone();
